  ...
  return (
    <nav className="border-b bg-teal-700 backdrop-blur shadow-sm">
      <div className="container mx-auto px-4 h-18 flex justify-between items-center ">
        <div className="flex">
          <Link href="/" className="justify-self-start flex items-center gap-3 group">
        ...
        <input  placeholder="Buscar por canción o artista" 
        ...
        <div className="flex items-center gap-8 text-white">
          <Link href="/" className="text-sm font-medium hover:text-primary transition-colors relative group py-2">
            Inicio
